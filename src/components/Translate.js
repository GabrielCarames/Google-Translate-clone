            ...
            <header className="translate-header">
                <div className="translate__left-navbar">
                    <ul className="translate-list">
                        ...
                        <button onClick={() => {dispatch({type: '@setSource', payload: languagesCosa.target}); dispatch({type: '@setTarget', payload: languagesCosa.source})}}> elotudo</button>
                    </ul>
                </div>
                <div className="translate__right-navbar">
                    <ul className="translate-list">
                        ...
                        <li className="list__arrow" onClick={() => {showList ? setShowList(false) : setShowList(true); setResults(false)}}><i class="fas fa-chevron-down"></i></li>
                        <button onClick={() => {dispatch({type: '@setTarget', payload: languagesCosa.source}); dispatch({type: '@setSource', payload: languagesCosa.target})}}> elotudo</button>
                    </ul>
                </div>
            </header>
